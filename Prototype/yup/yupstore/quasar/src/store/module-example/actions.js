...
export function fetchproduct ({ commit }, { userid }) {
    return Yup.fetchproduct({ userid })
        .then((response) => {
...
export function fetchproductinfo ({ commit }, { sid, sku }) {
    // alert(udata.mddomain)
    // console.log(sid);
    return Yup.fetchproductinfo({ sid, sku })
        .then((response) => {
...
export function deleteimage ({ commit }, { imageid, sku, sellerid }) {
    return Yup.deleteimage({ imageid, sku, sellerid })
        .then((response) => {
            commit('multiplepicker', response.data.data)
            // return response
        })
