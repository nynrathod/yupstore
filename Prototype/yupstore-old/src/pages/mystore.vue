      ...
      <q-page class="q-px-lg q-page">
        <div class="row">
          <div class="col-8 q-pr-lg">
            <div class="myshadow">
              <div
                class="row items-center q-pl-lg separator"
                style="
              ...
              <div class="row  items-center">
                <div class="col-3 q-px-xl q-py-lg">
                  <q-skeleton
                    type="square "
                    class="q-mb-md"
                  />
            ...
            <div class="myshadow bg-white q-mt-md">
              <div class="row  items-center">
                <span class="text-h6 q-pa-md">Pages</span>
                <q-space />
                <q-btn
                  label="Add New Page"
                  rounded
                ...
                <div class="row q-col-gutter-md q-my-md q-px-md">
                  <div class="col-3">
                    <q-card class="my-card">
                      <img src="https://image.freepik.com/free-vector/flat-cms-landing-page_23-2148810082.jpg">
                      <div
                        class="absolute-bottom text-subtitle2 text-center text-white q-pa-md"
...
.myshadow {
  box-shadow: 0px -2px 25px 0px rgba(152, 170, 198, 0.2);
}
</style>