      ...
      <q-page class="q-px-lg q-page">
        <div class="row">
          <div class="col-8 q-pr-lg">
                <div class="" style="background: #f0f4f7;">
                    <q-breadcrumbs class="q-pl-lg q-pt-lg">
                        <q-breadcrumbs-el label="Products" class="text-grey-7" />
                        <q-breadcrumbs-el label="Product 1" class="text-grey-6" />
                        </q-breadcrumbs>
                    <div class="row items-center q-pl-lg separator q-pb-xl" style="
                        ...
                        <div class="col-3"><q-btn outline rounded color="primary" label="Update Product" /></div>
                    </div>                    
                </div>
                <div class="myshadow bg-white q-mx-md">
                    <div class="row  items-center" style="margin-top: -50px;">
                ...
                <div class=" myshadow bg-white q-mx-md q-my-md">
                    ...
                    >
                        ...
                        <q-card-section class="text-grey">
                            <div class="row">
                                <div class="col-6 q-pr-md"><label class="text-caption">Name</label><q-input outlined v-model="text1" dense placeholder="Name" /></div>
                                <div class="col-6 q-pl-md"><label class="text-caption">Label</label><q-input outlined v-model="text2" dense   placeholder="Label" /></div>
                            </div>
                            <div class="row">
                                <div class="col-6 q-pr-md"><label class="text-caption">Price</label><q-input outlined v-model="text3" dense placeholder="Name" /></div>
                                <div class="col-3 q-pl-md"><label class="text-caption">Discount</label><q-input outlined v-model="text5" dense   placeholder="Label" /></div>
                                ...
                                />
                                <label class="text-caption">On Sale</label></div>
                            </div>
                            <div class="row">
                                <div class="col-12 q-py-md q-gutter-sm">
                                    <label class="text-caption">Description</label>
                                    <q-editor v-model="editor" min-height="10rem" style="font-size: 15px;" class="text-grey-8" />
                                </div>
                            </div>
                        </q-card-section>
                        </q-card>
                        ...
                        <q-card-section class="text-grey">
                             <div class="row">
                                ...
                                <div class="col-4 q-pr-md">
                                    ...
                                    <q-input outlined v-model="text6" dense   placeholder="SKU" />
                                </div>
                                <div class="col-4">
                                    <label class="text-caption">Weight</label>
                                    <q-input outlined v-model="text7" dense   placeholder="weight" />
                                </div>
                            </div>
                        </q-card-section>
                        </q-card>
          ...
          <div class="col-3">
            <div class="q-gutter-y-md">
              <q-skeleton height="250px" animation="none" style="background: #f0f4f7;" />
              <q-skeleton height="50px" animation="none" style="background: #f0f4f7;" />
              <q-skeleton height="50px" animation="none" style="background: #f0f4f7;" />
              <q-skeleton height="250px" animation="none" style="background: #f0f4f7;" />
            </div>
          </div>
...
.seperator { border-bottom: 1px solid #eee; }
.q-expansion-item__container .q-item { border-bottom: 1px solid #eee; }
.q-expansion-item__container .q-item { padding: 20px 36px !important; }
.q-expansion-item__content { padding: 14px 20px !important; }
</style>